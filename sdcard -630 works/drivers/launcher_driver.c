...
static struct usb_driver driver_0;
...
static int open(struct inode *inode, struct file *file)
{
	...
	interface = usb_find_interface(&driver_0, subminor);
	if (!interface) {
...
*/
	launch_input[0] = LAUNCHER_CTRL_COMMAND_PREFIX;
	launch_input[1] = (char) *user_buffer;
	launch_input[2] = 0;
	launch_input[3] = 0;
	launch_input[4] = 0;
	launch_input[5] = 0;
