...
-- Date:              Thu May 04 03:32:17 2017 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
  ...
  signal slv_reg_write_sel              : std_logic_vector(22 downto 0);
  signal slv_reg_read_sel               : std_logic_vector(22 downto 0);
...
begin
 ...
 security_pin <= shadow_security;
  ...
  -- 
  ------------------------------------------
  slv_reg_write_sel <= Bus2IP_WrCE(22 downto 0);
  slv_reg_read_sel  <= Bus2IP_RdCE(22 downto 0);
  slv_write_ack     <= Bus2IP_WrCE(0) or Bus2IP_WrCE(1) or Bus2IP_WrCE(2) or Bus2IP_WrCE(3) or Bus2IP_WrCE(4) or Bus2IP_WrCE(5) or Bus2IP_WrCE(6) or Bus2IP_WrCE(7) or Bus2IP_WrCE(8) or Bus2IP_WrCE(9) or Bus2IP_WrCE(10) or Bus2IP_WrCE(11) or Bus2IP_WrCE(12) or Bus2IP_WrCE(13) or Bus2IP_WrCE(14) or Bus2IP_WrCE(15) or Bus2IP_WrCE(16) or Bus2IP_WrCE(17) or Bus2IP_WrCE(18) or Bus2IP_WrCE(19) or Bus2IP_WrCE(20) or Bus2IP_WrCE(21) or Bus2IP_WrCE(22);
  slv_read_ack      <= Bus2IP_RdCE(0) or Bus2IP_RdCE(1) or Bus2IP_RdCE(2) or Bus2IP_RdCE(3) or Bus2IP_RdCE(4) or Bus2IP_RdCE(5) or Bus2IP_RdCE(6) or Bus2IP_RdCE(7) or Bus2IP_RdCE(8) or Bus2IP_RdCE(9) or Bus2IP_RdCE(10) or Bus2IP_RdCE(11) or Bus2IP_RdCE(12) or Bus2IP_RdCE(13) or Bus2IP_RdCE(14) or Bus2IP_RdCE(15) or Bus2IP_RdCE(16) or Bus2IP_RdCE(17) or Bus2IP_RdCE(18) or Bus2IP_RdCE(19) or Bus2IP_RdCE(20) or Bus2IP_RdCE(21) or Bus2IP_RdCE(22);
...
--                slv_reg4(byte_index*8+7 downto byte_index*8) <= Bus2IP_Data(byte_index*8+7 downto byte_index*8);
  ...
  SLAVE_REG_READ_PROC : process( slv_reg_read_sel, slv_reg0, slv_reg1, slv_reg2, slv_reg3, slv_reg4, slv_reg5, slv_reg6, slv_reg7, slv_reg8, slv_reg9, slv_reg10, slv_reg11, slv_reg12, slv_reg13, slv_reg14, slv_reg15, slv_reg16, slv_reg17, slv_reg18, slv_reg19, slv_reg20, slv_reg21, slv_reg22 ) is
  begin

    case slv_reg_read_sel is
      when "10000000000000000000000" => slv_ip2bus_data <= slv_reg0;
      when "01000000000000000000000" => slv_ip2bus_data <= slv_reg1;
      when "00100000000000000000000" => slv_ip2bus_data <= slv_reg2;
      when "00010000000000000000000" => slv_ip2bus_data <= slv_reg3;
      when "00001000000000000000000" => slv_ip2bus_data <= slv_reg4;
      when "00000100000000000000000" => slv_ip2bus_data <= slv_reg5;
      when "00000010000000000000000" => slv_ip2bus_data <= slv_reg6;
      when "00000001000000000000000" => slv_ip2bus_data <= slv_reg7;
      when "00000000100000000000000" => slv_ip2bus_data <= slv_reg8;
      when "00000000010000000000000" => slv_ip2bus_data <= slv_reg9;
      when "00000000001000000000000" => slv_ip2bus_data <= slv_reg10;
      when "00000000000100000000000" => slv_ip2bus_data <= slv_reg11;
      when "00000000000010000000000" => slv_ip2bus_data <= slv_reg12;
      when "00000000000001000000000" => slv_ip2bus_data <= slv_reg13;
      when "00000000000000100000000" => slv_ip2bus_data <= slv_reg14;
      when "00000000000000010000000" => slv_ip2bus_data <= slv_reg15;
      when "00000000000000001000000" => slv_ip2bus_data <= slv_reg16;
      when "00000000000000000100000" => slv_ip2bus_data <= slv_reg17;
      when "00000000000000000010000" => slv_ip2bus_data <= slv_reg18;
      when "00000000000000000001000" => slv_ip2bus_data <= slv_reg19;
      when "00000000000000000000100" => slv_ip2bus_data <= slv_reg20;
      when "00000000000000000000010" => slv_ip2bus_data <= slv_reg21;
      when "00000000000000000000001" => slv_ip2bus_data <= slv_reg22;
